          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class=""><a href="{{url ('category')}}"><i class="fa fa-file-text-o"></i>Category</a></li>
              </ul>
			       <ul class="treeview-menu">
				      <li class=""><a href="{{url ('supplier')}}"><i class="fa fa-file-text-o"></i>Supplier</a>
            </li>
            </ul> 
            <ul class="treeview-menu">
            <li class=""><a href="{{url ('departments')}}"><i class="fa fa-file-text-o"></i>Department</a>
            </li>
            </ul> 
             <ul class="treeview-menu">
            <li class=""><a href="{{url ('assets')}}"><i class="fa fa-file-text-o"></i>Assets</a>
            </li>
            </ul> 
            </li>

            
            <li class="treeview"><a href="{{url ('filter')}}">Filter</a>
            </li>
