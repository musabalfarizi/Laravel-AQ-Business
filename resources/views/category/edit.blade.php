...
<div class="col-xs-12">
  ...
  @endif
    ...
    <div class="box-body">
    <form method="post" action="{{ url ('category/updatePost', $category->id_category )}}" enctype="multipart/form-data">
          {{ csrf_field() }}
<table id="example2" class="table table-bordered table-hover">

<tr>
<td>Nama Category</td>
<td><input class="form-control" type="text" name="nama" value=" {{$category->nama}} "/>
</tr>
